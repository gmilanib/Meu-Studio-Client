...
export default function RelatorioFinanceiroPage() {
  ...
  async function confirmAction() {
    ...
    try {
      ...
      const response = await apiFetch(`/financeiro/faturamentos/${row.id}`, deleting ? { method: 'DELETE' } : { method: 'PUT', body: JSON.stringify({ data: row.data, cliente: row.cliente, clienteId: row.clienteId, procedimentoId: row.procedimentoId, valor: Number(row.valor), meioDePagamento: row.meioDePagamento }) })
